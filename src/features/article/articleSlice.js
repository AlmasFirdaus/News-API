...
const articleUnSavedPromise = (filteredUnSave) => {
  return new Promise((resolve, reject) => {
    if (filteredUnSave) {
      // console.log("prom", filteredUnSave);
...
const articleSlice = createSlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addCase(fetchArticleIndonesia.rejected, (state, action) => {
        state.isFetchPending = false;
      ...
      .addCase(fetchArticleIndonesia1.rejected, (state, action) => {
        state.isFetchPending = false;
        state.isFetchSuccess = false;
        state.errorMessage = action.error.message;
      })
      ...
      .addCase(fetchArticleProgramming.rejected, (state, action) => {
        state.isFetchPending = false;
        state.isFetchSuccess = false;
        state.errorMessage = action.error.message;
      })
      ...
      .addCase(fetchArticleCovid19.rejected, (state, action) => {
        state.isFetchPending = false;
        state.isFetchSuccess = false;
        state.errorMessage = action.error.message;
      })
      ...
      .addCase(fetchArticleSearch.rejected, (state, action) => {
        state.isFetchPending = false;
        state.isFetchSuccess = false;
        state.errorMessage = action.error.message;
      })
