...
const Home = () => {
  return (
    <>
      <section id="home">
        <div
          className="w-full h-screen bg-cover pt-36 px-16 md:px-20"
        ...
        >
          <div className="container h-1/2">
            <div className="w-full md:w-2/3 lg:w-1/2">
              ...
              <p className="font-medium text-slate-300 text-sm md:text-base pt-5 lg:text-2xl">Locate articles and breaking news headlines from news sources and blogs across the web with our JSON API</p>
            </div>
          </div>
        </div>
      </section>
